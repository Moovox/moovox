...
function Applications() {
    ...
    const loadApplications = async () => {
        try {
            ...
            if (error.message && !error.message.includes('No') && !error.message.includes('not found')) {
    ...
    return (
        <>
            ...
            <MainLayout title="Applications" className="min-h-screen bg-gradient-to-br from-[#fff8f0] via-[#f9e7c2] to-[#bfa77a]">
