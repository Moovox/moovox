...
export const applicationService = {
    async getAllApplications() {
        try {
            ...
            if (!farmId) {
                console.warn('Warning: Farm ID not found in localStorage. Applications may not be filtered correctly.');
            }

            const endpoint = farmId ? `/farms/${farmId}/applications` : '/applications';
            ...
            const applications = applicationsData.map(application => ({
                ...
                animalIdentification: application.animal_identification || application.animalIdentification || '-',
