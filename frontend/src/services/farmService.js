    ...
    checkSelectedFarm: async () => {
        try {
            ...
            if (response.data && response.data.data) {
                ...
                return { valid: false, message: 'The selected farm does not exist or has been removed' };
            }
        } catch (error) {
            ...
            if (error.response?.status === 404) {
                ...
                return { valid: false, message: 'The selected farm does not exist in the system' };
            }
            ...
            if (error.response?.status === 403) {
                ...
                return { valid: false, message: 'You do not have permission to access this farm' };
            }
