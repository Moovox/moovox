  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          error.message || "An error occurred while updating the vaccine",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <div className="space-y-1.5">
          ...
          />
          {errors.manufacturer && (
            <span className="text-xs text-red-500">{errors.manufacturer}</span>
          )}
        </div>
        <div className="space-y-1.5">
          <label className="text-sm font-medium text-amber-900">
          ...
          />
          {errors.batchNumber && (
            <span className="text-xs text-red-500">{errors.batchNumber}</span>
          )}
        </div>
        <div className="space-y-1.5">
          <label className="text-sm font-medium text-amber-900">
